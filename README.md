## Note: 
This fork is probably only necessary, if you want to install React-Navigation on mon-Unix based systems, standalone and test the examples. Usually the library is included via imports into main apps, which causes no problems on other OS's.
